...
import com.adars.aishim.service.ratelimit.InMemoryRateLimiterBackend
import com.adars.aishim.service.ratelimit.RateLimiterBackend
 ...
 * chosen at startup by the `aishim.ratelimit.backend` config property. The limiter itself is
...
class RateLimiter private constructor(
    ...
    constructor(
        ...
        @ConfigProperty(name = "aishim.rate-limit.requests-per-minute", defaultValue = "30")
        requestsPerMinute: Long,
        @ConfigProperty(name = "aishim.rate-limit.requests-per-day", defaultValue = "1000")
        requestsPerDay: Long,
