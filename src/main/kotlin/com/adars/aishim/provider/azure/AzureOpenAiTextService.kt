...
@ApplicationScoped
class AzureOpenAiTextService {

    @Inject
    @field:ModelName("azure-openai-text")
    lateinit var model: ChatModel

    @ConfigProperty(name = "quarkus.langchain4j.azure-openai.azure-openai-text.endpoint", defaultValue = "https://placeholder.openai.azure.com/")
