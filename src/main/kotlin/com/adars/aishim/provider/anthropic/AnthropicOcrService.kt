package com.adars.aishim.provider.anthropic
...
class AnthropicOcrService {
    ...
    @Inject
    @field:ModelName("anthropic-vision")
    lateinit var model: ChatModel

    @ConfigProperty(name = "quarkus.langchain4j.anthropic.anthropic-vision.chat-model.model-name", defaultValue = "claude-sonnet-4-20250514")
