package com.adars.aishim.provider.deepseek
...
/**
 * Text-only LLM service backed by DeepSeek.
 * DeepSeek exposes an OpenAI-compatible API — reuses the OpenAI extension
 * with a different named model config ("deepseek") pointing to api.deepseek.com.
 *
 * Vision/image input is NOT supported by DeepSeek.
 */
@ApplicationScoped
class DeepSeekTextService {

    @Inject
    @field:ModelName("deepseek")
