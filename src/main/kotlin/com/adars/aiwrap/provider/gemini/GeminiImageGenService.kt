...
import com.adars.aiwrap.model.GeneratedImage
import com.adars.aiwrap.model.ImageParams
import com.adars.aiwrap.model.ImageProviderResult
import com.adars.aiwrap.provider.image.ImageGenService
...
class GeminiImageGenService @Inject constructor(
    ...
    @ConfigProperty(name = "aiwrap.image.gemini.endpoint", defaultValue = "https://generativelanguage.googleapis.com/v1beta")
    private val endpoint: String,
    @ConfigProperty(name = "aiwrap.image.gemini.default-model", defaultValue = "gemini-2.5-flash-image")
    private val defaultModel: String,
    @ConfigProperty(name = "aiwrap.image.max-count", defaultValue = "4")
