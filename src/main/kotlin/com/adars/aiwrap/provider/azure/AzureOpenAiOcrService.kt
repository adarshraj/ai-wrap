package com.adars.aiwrap.provider.azure
...
@ApplicationScoped
class AzureOpenAiOcrService {

    @Inject
    @field:ModelName("azure-openai-vision")
    lateinit var model: ChatModel

    @ConfigProperty(name = "quarkus.langchain4j.azure-openai.azure-openai-vision.endpoint", defaultValue = "https://placeholder.openai.azure.com/")
    lateinit var endpoint: String

    @ConfigProperty(name = "quarkus.langchain4j.azure-openai.azure-openai-vision.chat-model.deployment-name", defaultValue = "gpt-4o-mini")
    lateinit var defaultDeploymentName: String
    ...
    private fun buildDynamic(apiKey: String, params: ModelParams?): ChatModel =
        OpenAiChatModel.builder()
            .apiKey(apiKey)
            .baseUrl(params?.baseUrl ?: endpoint)
            .modelName(params?.model ?: defaultDeploymentName)
