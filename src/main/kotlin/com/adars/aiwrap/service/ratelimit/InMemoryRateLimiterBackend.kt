...
/**
 * In-process counter backend. Selected when `aiwrap.ratelimit.backend=memory` (the default).
 *
 ...
 */
@ApplicationScoped
@LookupIfProperty(name = "aiwrap.ratelimit.backend", stringValue = "memory", lookupIfMissing = true)
